...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        codeIV.image = [UIImage imageNamed:@"qrcode_scan_pic"];
...
-(void)startcScanningQrcord{
    ...
    if (_input == nil) {
        UIAlertView *aler = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"提示", nil)  message:NSLocalizedString(@"设备不可用", nil) delegate:nil cancelButtonTitle:nil otherButtonTitles:NSLocalizedString(@"确定",nil), nil];
