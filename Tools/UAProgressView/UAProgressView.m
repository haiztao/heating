...
{
    if (_tintColor == nil) {
        _tintColor = [UIColor whiteColor];//进度条颜色
    }
    return _tintColor;
}
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated {
    ...
    self.progressView.shapeLayer.strokeColor = self.strokeColor.CGColor;
...
//    CGFloat value = progress * 265.0f;
//    if (value < 35) {
//    self.progressView.shapeLayer.strokeColor = self.strokeColor.CGColor;
//    }else if (value < 70){
//        self.progressView.shapeLayer.strokeColor = kOrangeColor.CGColor;
//    }else if (value < 100){
//        self.progressView.shapeLayer.strokeColor = kDarkOrgColor.CGColor;
//    }else if (value < 150){
//        self.progressView.shapeLayer.strokeColor = kRedColor.CGColor;
//    }else if (value < 200){
//        self.progressView.shapeLayer.strokeColor = kPurpleColor.CGColor;
//    }else{
//        self.progressView.shapeLayer.strokeColor = kBrowColor.CGColor;
//    }
...
//    const double endAngle = startAngle + TWO_M_PI;
    ...
    const double startAngle = 160 * M_PI / 180;
    const double endAngle = 382 * M_PI / 180;
